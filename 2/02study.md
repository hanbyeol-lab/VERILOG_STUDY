...
: 위의 형식을 보면 알 수 있듯이 module이 더 큰 개념이고 function은 그 기능을 해주는 함수로써 
사용되는 것을 알 수 있다.
...
때문에 function은하나의 출력을 생성하는 일반적인 베릴로그 코드나 완전한 조합논리회로에서 
사용되며 베릴로그 모델링 시 피연산자로 작용하고, task는 함수보다 다양한 목적을 위해 사용된다.
